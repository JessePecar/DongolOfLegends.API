...
namespace DongolOfLegends.API.Models.Models.Champions
{
    ...
    public class AurelionSol: Champion
    {
    }
...
: Champion
    ...
    public class Yone : Champion
    {

    }

    public class Yorick : Champion
    {

    }

    public class Yuumi : Champion
    {
    ...
    public class Zilean : Champion
    {

    }

    public class Zoe : Champion
    {

    }

    public class Zyra : Champion
    {
